...
请通过仓库 **Security → Report a vulnerability** 提交（Private vulnerability reporting 已开启，[报告入口文档](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing-information-about-vulnerabilities#privately-reporting-a-vulnerability)）。不要在 Issue/PR/讨论中公开披露。
